<main class="flex-1 p-10 flex flex-col h-full overflow-y-auto">
    <div class="w-full relative mb-6">
        ...
        <input type="text" placeholder="Search FAQ..."
            class="w-full pl-11 pr-4 py-2.5 rounded-full bg-white shadow-sm text-sm text-gray-600 outline-none placeholder-gray-400 border border-gray-100 focus:border-[#80c4b7] transition-all">
    </div>

    <div class="mb-6">
        <h2 class="text-3xl font-extrabold text-[#2d3436] tracking-wide">Frequently Asked Questions</h2>
    </div>

    <div class="w-full h-48 rounded-3xl shadow-sm mb-8 overflow-hidden border border-gray-100 bg-gray-100">
    ...
    <div class="grid grid-cols-3 gap-8 items-start mb-8">
        <div class="col-span-2 flex flex-col gap-6">
            <!-- General Section -->
            <div>
                <div class="flex items-center gap-2 mb-3 font-extrabold text-[#2d3436] text-lg">
                    <i class="fas fa-check-circle text-[#80c4b7]"></i>
                    <h3>General</h3>
                </div>
                <div class="flex flex-col gap-3">
                    <details class="faq-item">
                        <summary>
                            ...
                            <i class="fas fa-plus text-xs text-[#80c4b7]"></i>
                        </summary>
                        <div class="mx-4 pb-4 text-sm text-[#636e72] border-t-2 border-gray-200 pt-3 leading-relaxed">
                    ...
                    <details class="faq-item">
                        <summary>
                            <span class="text-sm">Berapa batas maksimal peserta pada setiap lomba yang dapat diikuti?</span>
                            <i class="fas fa-plus text-xs text-[#80c4b7]"></i>
                        </summary>
                        <div class="mx-4 pb-4 text-sm text-[#636e72] border-t-2 border-gray-200 pt-3 leading-relaxed">
            ...
            <div>
                <div class="flex items-center gap-2 mb-3 font-extrabold text-[#2d3436] text-lg">
                    <i class="fas fa-file-alt text-[#80c4b7]"></i>
                    <h3>Registration</h3>
                </div>
                <div class="flex flex-col gap-3">
                    <details class="faq-item">
                    ...
                    <details class="faq-item">
                        <summary>
                            <span class="text-sm">Bisakah saya membatalkan pendaftaran lomba yang sudah diikuti?</span>
                            <i class="fas fa-plus text-xs text-[#80c4b7]"></i>
                        </summary>
                        <div class="mx-4 pb-4 text-sm text-[#636e72] border-t-2 border-gray-200 pt-3 leading-relaxed">
                    ...
                    <details class="faq-item">
                        ...
                        <div class="mx-4 pb-4 text-sm text-[#636e72] border-t-2 border-gray-200 pt-3 leading-relaxed">
                            Kamu bisa mengeceknya secara berkala melalui menu "Participant" kamu. Di sana akan tertera
            ...
            <div>
                <div class="flex items-center gap-2 mb-3 font-extrabold text-[#2d3436] text-lg">
                    <i class="fas fa-users text-[#80c4b7]"></i>
                    <h3>Participation</h3>
                </div>
                <div class="flex flex-col gap-3">
                    <details class="faq-item">
                    ...
                    <details class="faq-item">
                        <summary>
                            <span class="text-sm">Bagaimana kalau kuota lomba sudah penuh saat sedang mendaftar?</span>
                            <i class="fas fa-plus text-xs text-[#80c4b7]"></i>
                        </summary>
                        <div class="mx-4 pb-4 text-sm text-[#636e72] border-t-2 border-gray-200 pt-3 leading-relaxed">
        ...
        <!-- Sidebar Card -->
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden flex flex-col border border-gray-50 sticky top-10">
            <div class="w-full h-44 bg-[#e8f5f2] flex items-center justify-center overflow-hidden">
                <i class="fas fa-headset text-6xl text-[#80c4b7] opacity-20"></i>
            </div>

            <div class="bg-gradient-to-b from-[#80c4b7] to-[#64b3a4] text-white p-6 flex flex-col gap-4 flex-1">
                ...
                <div class="bg-white rounded-xl p-5 text-[#80c4b7] flex flex-col gap-4 shadow-inner mt-2">
