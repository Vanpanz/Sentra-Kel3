    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8 lg:px-12 overflow-y-auto">
            ...
            <div class="flex flex-wrap gap-4 mb-10">
                <button
                    class="bg-[#64b3a4] hover:bg-[#4c8c80] text-white px-6 py-2.5 rounded-xl font-bold shadow-[0_4px_15px_rgba(100,179,164,0.3)] transition-all duration-300 transform hover:-translate-y-0.5">
                    + Create Event
                </button>
                <button
                    class="bg-white hover:bg-gray-50 text-[#636e72] px-6 py-2.5 rounded-xl font-bold shadow-sm border border-gray-200 transition-all duration-300">
                    📣 Announcement
                </button>
            </div>
            ...
            <section class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div
                    class="bg-white p-6 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-gray-50 text-center">
            ...
            <section class="mb-10">
                ...
                <a href="#" class="block group">
                    <div
                        class="bg-white rounded-3xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-gray-100 transition-all duration-300 group-hover:shadow-[0_15px_35px_rgba(100,179,164,0.15)] group-hover:-translate-y-1">
                        <div
                            class="h-40 bg-gradient-to-r from-[#80c4b7] to-[#64b3a4] flex items-center justify-center p-6">
                            <h2 class="text-white text-3xl font-extrabold tracking-wide drop-shadow-md text-center">
                                Sekolah XYZ - Class Meeting</h2>
                        </div>
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-4">
                                <span
                                    class="bg-[#80c4b7]/20 text-[#4c8c80] px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider">
                                    Ongoing
                                </span>
            ...
            <section class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div
                        class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
                        <div
                            class="w-16 h-16 bg-[#f4f9f8] rounded-xl flex-shrink-0 flex items-center justify-center text-2xl">
                            ⚽</div>
                        <div>
                            <h4 class="font-bold text-[#2d3436]">Futsal Tournament</h4>
                            <p class="text-[11px] text-[#636e72] font-medium mb-1.5">10 Des 20XX</p>
                            <span
                                class="bg-[#80c4b7]/20 text-[#4c8c80] text-[10px] px-2.5 py-1 rounded-md font-bold uppercase">Ongoing</span>
                        </div>
                    </div>
                    ...
                    <div
                        class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
                        <div
                            class="w-16 h-16 bg-blue-50 rounded-xl flex-shrink-0 flex items-center justify-center text-2xl">
                            🔬</div>
                        <div>
                            <h4 class="font-bold text-[#2d3436]">Science Fair</h4>
                            <p class="text-[11px] text-[#636e72] font-medium mb-1.5">5-7 Des 20XX</p>
                            <span
                                class="bg-blue-50 text-blue-600 text-[10px] px-2.5 py-1 rounded-md font-bold uppercase">Upcoming</span>
                        </div>
                    </div>
                    ...
                    <div
                        class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
                        <div
                            class="w-16 h-16 bg-red-50 rounded-xl flex-shrink-0 flex items-center justify-center text-2xl">
                            🎨</div>
                        <div>
                            <h4 class="font-bold text-[#2d3436]">Art Exhibition</h4>
                            <p class="text-[11px] text-[#636e72] font-medium mb-1.5">2 Des 20XX</p>
                            <span
                                class="bg-red-50 text-red-600 text-[10px] px-2.5 py-1 rounded-md font-bold uppercase">Full</span>
                        </div>
                    </div>
                </div>
            </section>
